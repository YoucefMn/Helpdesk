...
partial class FGlpi
{
    ...
    private void InitializeComponent()
    {
        ...
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FGlpi));
        ...
        panel1.CustomizableEdges = customizableEdges4;
        panel1.Dock = DockStyle.Top;
        panel1.FillColor = Color.FromArgb(244, 226, 215);
        panel1.FillColor2 = Color.FromArgb(178, 153, 138);
        panel1.FillColor3 = Color.FromArgb(244, 226, 215);
        panel1.FillColor4 = Color.FromArgb(91, 61, 42);
        panel1.Location = new Point(0, 0);
        panel1.Name = "panel1";
        panel1.Quality = 100;
        panel1.ShadowDecoration.CustomizableEdges = customizableEdges5;
        panel1.Size = new Size(280, 25);
        panel1.TabIndex = 22;
        // 
        ...
        guna2CirclePictureBox1.Size = new Size(30, 25);
        ...
        guna2Button1.Location = new Point(246, 0);
        guna2Button1.Name = "guna2Button1";
        guna2Button1.ShadowDecoration.CustomizableEdges = customizableEdges3;
        guna2Button1.Size = new Size(34, 25);
        guna2Button1.TabIndex = 5;
        guna2Button1.Click += Exit;
        // 
        // label14
        // 
        ...
        button2.CustomizableEdges = customizableEdges6;
        ...
        button2.FillColor = Color.FromArgb(217, 201, 181);
        button2.Font = new Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point);
        button2.ForeColor = Color.FromArgb(91, 61, 42);
        button2.Image = (Image)resources.GetObject("button2.Image");
        button2.ImageAlign = HorizontalAlignment.Left;
        button2.ImageSize = new Size(30, 25);
        button2.Location = new Point(143, 90);
        button2.Name = "button2";
        button2.ShadowDecoration.CustomizableEdges = customizableEdges7;
        button2.Size = new Size(105, 37);
        button2.TabIndex = 33;
        button2.Text = "NEW";
        button2.TextAlign = HorizontalAlignment.Left;
        button2.Click += Install;
        // 
        // button1
        // 
        button1.Animated = true;
        button1.BorderRadius = 8;
        button1.CustomizableEdges = customizableEdges8;
        ...
        button1.FillColor = Color.FromArgb(217, 201, 181);
        button1.Font = new Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point);
        button1.ForeColor = Color.FromArgb(91, 61, 42);
        button1.Image = (Image)resources.GetObject("button1.Image");
        button1.ImageAlign = HorizontalAlignment.Left;
        button1.ImageSize = new Size(30, 25);
        button1.Location = new Point(35, 90);
        button1.Name = "button1";
        button1.ShadowDecoration.CustomizableEdges = customizableEdges9;
        button1.Size = new Size(88, 37);
        button1.TabIndex = 32;
        button1.Text = "OLD";
        button1.TextAlign = HorizontalAlignment.Left;
        button1.Click += Install2;
        // 
        // cb
        // 
        cb.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
        cb.BackColor = Color.FromArgb(217, 201, 181);
        cb.DropDownHeight = 70;
        cb.FlatStyle = FlatStyle.Flat;
        cb.Font = new Font("Bahnschrift SemiCondensed", 11F, FontStyle.Bold, GraphicsUnit.Point);
        cb.FormattingEnabled = true;
        cb.IntegralHeight = false;
        cb.Location = new Point(12, 51);
        cb.Name = "cb";
        cb.Size = new Size(252, 26);
        cb.Sorted = true;
        cb.TabIndex = 34;
        ...
        BackColor = Color.FromArgb(244, 226, 215);
